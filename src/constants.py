...
OCH_ADD_SUBCLASS_DOMAIN = f'{OCH_PREFIX}:sourceAddSubClass' 
OCH_ADD_SUBCLASS_RANGE = f'{OCH_PREFIX}:targetAddSubClass'

OCH_REMOVE_SUBCLASS_DOMAIN = f'{OCH_PREFIX}:sourceRemoveSubClass'
OCH_REMOVE_SUBCLASS_RANGE = f'{OCH_PREFIX}:targetRemoveSubClass'
