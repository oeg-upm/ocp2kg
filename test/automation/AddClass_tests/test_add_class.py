...
class TestAddClass01(unittest.TestCase):
    ...
    def test_add_class00(self):
        ...
        os.system(f"python3 {ruta_relativa}/src/ocp2kg/evol_kg.py -c {ruta_relativa}/test/automation/AddClass_tests/changes_add_class.ttl -m {ruta_relativa}/test/automation/AddClass_tests/expected_mapping_add_class.ttl -o {ruta_relativa}/examples/ppds/epo-ontology/ePO_3.1.ttl -n {ruta_relativa}/test/automation/AddClass_tests/output.ttl")
