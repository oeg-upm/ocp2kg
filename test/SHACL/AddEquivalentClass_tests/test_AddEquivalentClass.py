...
class TestAddEquivalentClassSH(unittest.TestCase):
    ...
    def test_equivalent_class00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_AddEquivalentClass.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests AddEquivalentClass Passed for SHACL Shapes")