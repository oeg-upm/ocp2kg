...
class TestAddInverseFunctionalPropertySH(unittest.TestCase):
    
    def test_add_InverseFunctionalProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_AddInverseFunctionalProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests AddInverseFunctionalProperty Passed for SHACL Shapes")