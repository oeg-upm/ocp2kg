...
class TestDeprecateEntity01(unittest.TestCase):
    ...
    def test_deprecate_entity00(self):
    ...
    def test_deprecate_entity01(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Property_Tests/changes_deprecate_property.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests DeprecateEntity Passed for SHACL Shapes")