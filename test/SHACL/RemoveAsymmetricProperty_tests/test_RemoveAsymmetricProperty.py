...
class TestRemoveAsymmetricPropertySH(unittest.TestCase):
    
    def test_Remove_AsymmetricProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveAsymmetricProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveAsymmetricProperty Passed for SHACL Shapes")