...
class TestAddEquivalentClassSH(unittest.TestCase):
    
    def test_remove_equivalent_class00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveEquivalentClass.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveEquivalentClass Passed for SHACL Shapes")