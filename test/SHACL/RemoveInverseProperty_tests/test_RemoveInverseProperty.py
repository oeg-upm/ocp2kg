...
class TestRemoveInversePropertySH(unittest.TestCase):
    def test_remove_TransitiveProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveInverseProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveInverseProperty Passed for SHACL Shapes")