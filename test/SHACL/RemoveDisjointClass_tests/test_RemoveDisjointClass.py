...
class TestRemoveDisjointClassSH(unittest.TestCase):
    
    def test_Disjoint_class00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveDisjointClass.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveDisjointClass Passed for SHACL Shapes")