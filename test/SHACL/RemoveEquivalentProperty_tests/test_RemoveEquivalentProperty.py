...
class TestRemoveEquivalentPropertySH(unittest.TestCase):
    def test_remove_EquivalentProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveEquivalentProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveEquivalentProperty Passed for SHACL Shapes")