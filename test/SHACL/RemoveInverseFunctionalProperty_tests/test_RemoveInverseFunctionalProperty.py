...
class TestRemoveInverseFunctionalPropertySH(unittest.TestCase):
    
    def test_remove_InverseFunctionalProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveInverseFunctionalProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveInverseFunctionalProperty Passed for SHACL Shapes")