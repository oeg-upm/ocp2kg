...
class TestAddIrreflexivePropertySH(unittest.TestCase):
    
    def test_add_IrreflexiveProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_AddIrreflexiveProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests AddIrreflexiveProperty Passed for SHACL Shapes")