...
class TestAddAsymmetricPropertySH(unittest.TestCase):
    
    def test_add_AsymmetricProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_AddAsymmetricProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests AddAsymmetricProperty Passed for SHACL Shapes")