...
class TestRemoveReflexivePropertySH(unittest.TestCase):
    
    def test_remove_ReflexiveProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveReflexiveProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveReflexiveProperty Passed for SHACL Shapes")