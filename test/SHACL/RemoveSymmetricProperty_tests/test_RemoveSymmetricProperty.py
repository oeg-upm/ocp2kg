...
class TestRemoveSymmetricPropertySH(unittest.TestCase):
    
    def test_Remove_SymmetricProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveSymmetricProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveSymmetricProperty Passed for SHACL Shapes")