...
class TestAddDisjointPropertySH(unittest.TestCase):
    def test_add_TransitiveProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_AddDisjointProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests AddDisjointProperty Passed for SHACL Shapes")