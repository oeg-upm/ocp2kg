...
class TestRemoveClassSH(unittest.TestCase):

    """Case 0: An OWL Class is removed and its corresponding sh:NodeShape is removed."""
    def test_remove_class00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveClass.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveClass Passed for SHACL Shapes")