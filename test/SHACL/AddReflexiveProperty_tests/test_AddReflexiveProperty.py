...
class TestAddReflexivePropertySH(unittest.TestCase):
    
    def test_add_ReflexiveProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_AddReflexiveProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests AddReflexiveProperty Passed for SHACL Shapes")