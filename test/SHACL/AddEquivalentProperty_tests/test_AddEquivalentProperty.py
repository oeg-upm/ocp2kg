...
class TestAddEquivalentPropertySH(unittest.TestCase):
    def test_add_EquivalentProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_AddEquivalentProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests AddEquivalentProperty Passed for SHACL Shapes")