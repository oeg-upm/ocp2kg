...
class TestAddSymmetricPropertySH(unittest.TestCase):
    
    def test_add_SymmetricProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_AddSymmetricProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests AddSymmetricProperty Passed for SHACL Shapes")