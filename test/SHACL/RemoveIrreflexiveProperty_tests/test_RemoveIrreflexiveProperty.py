...
class TestRemoveIrreflexivePropertySH(unittest.TestCase):
    
    def test_remove_IrreflexiveProperty00(self):
        change_data = Graph().parse(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'changes_RemoveIrreflexiveProperty.ttl'))
...
if __name__ == "__main__":
    unittest.main()
    print("Tests RemoveIrreflexiveProperty Passed for SHACL Shapes")